package com.panaceasoft.riftblackmarket.api;

import androidx.lifecycle.LiveData;

import com.panaceasoft.riftblackmarket.viewobject.AboutUs;
import com.panaceasoft.riftblackmarket.viewobject.ApiStatus;
...
public interface PSApiService {
    ...
    LiveData<ApiResponse<List<com.panaceasoft.riftblackmarket.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("item_id") String itemId, @Path("limit") String limit, @Path("offset") String offset);

    //endregion

    //region Get comment detail list
    @GET("rest/commentdetails/get/api_key/{API_KEY}/header_id/{header_id}/limit/{limit}/offset/{offset}")
    LiveData<ApiResponse<List<com.panaceasoft.riftblackmarket.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    Call<ApiStatus> rawRegisterNotiToken(@Path("API_KEY") String apiKey, @Field("platform_name") String platform, @Field("device_token") String deviceId);


    @FormUrlEncoded
    @POST("rest/notis/unregister/api_key/{API_KEY}")
    Call<ApiStatus> rawUnregisterNotiToken(@Path("API_KEY") String apiKey, @Field("platform_name") String platform, @Field("device_token") String deviceId);
...
//    //endregion
    ...
    Call<User> postFBUser(@Path("API_KEY") String apiKey, @Field("facebook_id") String facebookId, @Field("user_name") String userName, @Field("user_email") String userEmail, @Field("profile_photo_url") String profilePhotoUrl, @Field("device_token") String deviceToken);
    ...
    LiveData<ApiResponse<List<Rating>>> getAllRatingList(@Path("API_KEY") String apiKey, @Field("user_id") String itemId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    //region SearchCity
    @FormUrlEncoded
    @POST("rest/userfollows/search/api_key/{API_KEY}")//same with search user api//different return type
    ...
    LiveData<ApiResponse<User>> getUserById(@Path("API_KEY") String apiKey, @Path("id") String Id);
