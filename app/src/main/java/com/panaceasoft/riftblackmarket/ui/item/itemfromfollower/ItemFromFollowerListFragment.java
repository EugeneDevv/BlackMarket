...
import com.panaceasoft.riftblackmarket.databinding.FragmentItemFromFollowerListBinding;
...
//                    itemFromFollowerViewModel.catId = getActivity().getIntent().getExtras().getString(Constants.CATEGORY_ID);
//                    itemParameterHolder.cat_id = itemFromFollowerViewModel.catId;
