package com.panaceasoft.riftblackmarket.ui.item.rating;
...
import com.panaceasoft.riftblackmarket.databinding.FragmentRatingListBinding;
import com.panaceasoft.riftblackmarket.databinding.ItemRatingEntryBinding;
...
import com.panaceasoft.riftblackmarket.ui.item.rating.adapter.RatingListAdapter;
                ...
                if (layoutManager != null) {
                    ...
                    if (lastPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!ratingViewModel.forceEndLoading) {
                            ...
                            ratingViewModel.setNextPageLoadingStateObj(itemViewModel.userId, String.valueOf(Config.RATING_COUNT), Constants.ZERO);
            ...
            if (getActivity() != null) {
                if (getActivity().getIntent() != null) {
                    if (getActivity().getIntent().getExtras() != null) {
                        ...
                        itemViewModel.userId = getActivity().getIntent().getExtras().getString(Constants.ITEM_USER_ID);
...
//         Load item detail
        ...
        //rating list
        ratingViewModel.setRatingListObj(itemViewModel.userId, String.valueOf(Config.RATING_COUNT), Constants.ZERO);
    ...
    private void bindingProgressBar(Item item) {
        ...
        binding.get().ProgressBar1.setProgress((int) item.user.ratingDetails.fiveStarPercent);
        binding.get().ProgressBar2.setProgress((int) item.user.ratingDetails.fourStarPercent);
        binding.get().ProgressBar3.setProgress((int) item.user.ratingDetails.threeStarPercent);
        binding.get().ProgressBar4.setProgress((int) item.user.ratingDetails.twoStarPercent);
        binding.get().ProgressBar5.setProgress((int) item.user.ratingDetails.oneStarPercent);
        ...
        itemRatingEntryBinding.get().submitButton.setOnClickListener(v -> {
            ...
            if(itemRatingEntryBinding.get().titleEditText.getText().toString().isEmpty() ||
                ...
                ratingViewModel.setRatingPostObj(itemRatingEntryBinding.get().titleEditText.getText().toString(),
                        ...
                        loginUserId, itemViewModel.userId);
    ...
    private void bindingRatingData(Item item) {
        ...
        binding.get().totalRatingCountTextView.setText(getString(R.string.rating__total_count, String.valueOf(item.user.ratingDetails.totalRatingCount)));
        binding.get().totalRatingValueTextView.setText(getString(R.string.rating__total_value, String.valueOf((int) item.user.ratingDetails.totalRatingValue)));

        binding.get().ratingCountTextView1.setText(getString(R.string.rating__five_star));
        binding.get().ratingPercentTextView1.setText(getString(R.string.rating__percent, String.valueOf((int) item.user.ratingDetails.fiveStarPercent)));

        binding.get().ratingCountTextView2.setText(getString(R.string.rating__four_star));
        binding.get().ratingPercentTextView2.setText(getString(R.string.rating__percent, String.valueOf((int) item.user.ratingDetails.fourStarPercent)));

        binding.get().ratingCountTextView3.setText(getString(R.string.rating__three_star));
        binding.get().ratingPercentTextView3.setText(getString(R.string.rating__percent, String.valueOf((int) item.user.ratingDetails.threeStarPercent)));

        binding.get().ratingCountTextView4.setText(getString(R.string.rating__two_star));
        binding.get().ratingPercentTextView4.setText(getString(R.string.rating__percent, String.valueOf((int) item.user.ratingDetails.twoStarPercent)));

        binding.get().ratingCountTextView5.setText(getString(R.string.rating__one_star));
        binding.get().ratingPercentTextView5.setText(getString(R.string.rating__percent, String.valueOf((int) item.user.ratingDetails.oneStarPercent)));

        binding.get().ratingBar.setRating(item.user.ratingDetails.totalRatingValue);
