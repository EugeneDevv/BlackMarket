package com.panaceasoft.riftblackmarket.ui.item.search.searchlist;
...
import com.panaceasoft.riftblackmarket.databinding.FragmentItemListBinding;
    ...
    protected void initAdapters() {
        ...
        ItemVerticalListAdapter nvAdapter = new ItemVerticalListAdapter(dataBindingComponent, new ItemVerticalListAdapter.NewsClickCallback() {
            ...
            public void onClick(Item item) {
                navigationController.navigateToItemDetailActivity(SearchListFragment.this.getActivity(), item.id, item.title);
            }
        }, this);
