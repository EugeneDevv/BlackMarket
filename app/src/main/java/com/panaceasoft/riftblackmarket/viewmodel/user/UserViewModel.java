package com.panaceasoft.riftblackmarket.viewmodel.user;
...
import com.panaceasoft.riftblackmarket.repository.user.UserRepository;
...
public class UserViewModel extends PSViewModel {
    ...
    public UserViewModel(UserRepository repository) {
        ...
        userData = Transformations.switchMap(userObj, userId -> {
            ...
            Utils.psLog("UserViewModel : userLoginData");
            return repository.getLoginUser(Config.API_KEY, userId);
        });
