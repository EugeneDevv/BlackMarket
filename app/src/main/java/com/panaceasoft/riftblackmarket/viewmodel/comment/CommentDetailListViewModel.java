package com.panaceasoft.riftblackmarket.viewmodel.comment;
...
import com.panaceasoft.riftblackmarket.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.riftblackmarket.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.panaceasoft.riftblackmarket.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.riftblackmarket.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();
