...
import com.panaceasoft.riftblackmarket.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.riftblackmarket.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String itemId,
        ...
        if (!isLoading) {
            com.panaceasoft.riftblackmarket.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.riftblackmarket.viewmodel.comment.CommentListViewModel.TmpDataHolder();
